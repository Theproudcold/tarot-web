...
- **三张时间线牌阵**：过去 / 现在 / 未来，抽牌时支持 Framer Motion 物理弹簧飞入及落桌回弹动效。
- **神秘美学与毛玻璃视觉 (Glassmorphism)**：精致的宇宙星尘光晕（Stellar Glow）自转背景，全站面板统一的高级暗金极细描边与微悬浮发光。
- **卡组卡片式交互解读**：摒弃超长纵向平铺，“逐张解读”改由带正逆位状态徽章的“过去/现在/未来”卡片卡组 Tab 交互切换，阅读聚焦、体验高级。
- **仪式感 Loading 骨架屏**：解读时展现双重魔法星轨圆盘顺逆旋转，配合 HSL 呼吸柱体骨架，极大地增添了塔罗秘仪的占卜质感。
